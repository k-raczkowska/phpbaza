...
if (isset($_GET['id_cwiczenia'])) {
    ...
    $result = mysql_query("SELECT ilosc_wykonanych FROM cwiczenie_uzytkownika WHERE id_cwiczenia = $id_cwiczenia AND data_wykonania < current_date ORDER BY data_wykonania DESC LIMIT 1");
